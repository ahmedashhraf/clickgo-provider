...
class DashboardResponse {
  ...
  num? remainingPayout;
  BannerData? downGradeBanner;
  BannerData? upGradeBanner;
  ...
  DashboardResponse.fromJson(Map<String, dynamic> json) {
    ...
    it.forEachIndexed((element, index) {
      if ((element as Map).containsKey('${index + 1}')) {
        chartData.add(RevenueChartData(month: months[index], revenue: element[(index + 1).toString()].toString().toDouble(), index: index));
      } else {
        chartData.add(RevenueChartData(month: months[index], revenue: 0, index: index));
      }
    });
    ...
    downGradeBanner = json['downgrade_banner'] != null ? BannerData.fromJson(json['downgrade_banner']) : null;
    upGradeBanner = json['upgrade_banner'] != null ? BannerData.fromJson(json['upgrade_banner']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (downGradeBanner != null) {
      data['downgrade_banner'] = downGradeBanner!.toJson();
    }
    if (upGradeBanner != null) {
      data['upgrade_banner'] = upGradeBanner!.toJson();
    }
    return data;
  }
}
...
class BannerData {
  ...
  BannerData({this.title, this.description});
