...
Future<void> setAppConfigurations(AppConfigurationModel data) async {
  ...
  await appConfigurationStore.setIsNearbyProviderEnable(data.isNearbyProviderEnable.validate().getBoolInt());
  ...
  if (data.roleAndPermission != null) {
    ...
    await rolesAndPermissionStore.setShop(data.roleAndPermission!.shop.getBoolInt());
    await rolesAndPermissionStore.setShopAdd(data.roleAndPermission!.shopAdd.getBoolInt());
    await rolesAndPermissionStore.setShopEdit(data.roleAndPermission!.shopEdit.getBoolInt());
    await rolesAndPermissionStore.setShopList(data.roleAndPermission!.shopList.getBoolInt());
    await rolesAndPermissionStore.setShopDelete(data.roleAndPermission!.shopDelete.getBoolInt());
    await rolesAndPermissionStore.setShopDocument(data.roleAndPermission!.shopDocument.getBoolInt());
    await rolesAndPermissionStore.setShopdocumentAdd(data.roleAndPermission!.shopdocumentAdd.getBoolInt());
    await rolesAndPermissionStore.setShopdocumentEdit(data.roleAndPermission!.shopdocumentEdit.getBoolInt());
    await rolesAndPermissionStore.setShopdocumentList(data.roleAndPermission!.shopdocumentList.getBoolInt());
    await rolesAndPermissionStore.setShopdocumentDelete(data.roleAndPermission!.shopdocumentDelete.getBoolInt());
...
const SHOP_DOCUMENT = 'SHOP_DOCUMENT';
const SHOPDOCUMENT_LIST = 'SHOPDOCUMENT_LIST';
const SHOPDOCUMENT_ADD = 'SHOPDOCUMENT_ADD';
const SHOPDOCUMENT_EDIT = 'SHOPDOCUMENT_EDIT';
const SHOPDOCUMENT_DELETE = 'SHOPDOCUMENT_DELETE';
...
const IS_NEARBY_PROVIDER_ENABLE = 'is_nearby_provider_enable';
//endregion
...
class AppConfigurationModel {
  ...
  AppConfigurationModel.fromJsonMap(Map<String, dynamic> map)
      : siteName = map["site_name"],
        ...
        isNearbyProviderEnable = map["is_nearby_provider_enable"] ?? 0,
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_nearby_provider_enable'] = isNearbyProviderEnable;
...
class LiveValue {
  ...
  factory LiveValue.fromJson(Map<String, dynamic> json) {
    return LiveValue(
      ...
      phonepeVersion: json["phonepe_version"],
      merchantIdV1: json["merchant_id_v1"],
      saltKeyV1: json["salt_key_v1"],
      saltIndexV1: json["salt_index_v1"],
      merchantIdV2: json["merchant_id_v2"],
      clientIdV2: json["client_id_v2"],
      clientSecretV2: json["client_secret_v2"],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['merchant_id_v1'] = merchantIdV1;
    data['salt_key_v1'] = saltKeyV1;
    data['salt_index_v1'] = saltIndexV1;
    data['merchant_id_v2'] = merchantIdV2;
    data['client_id_v2'] = clientIdV2;
    data['client_secret_v2'] = clientSecretV2;
...
class RolesAndPermissionModel {
  ...
  int? shopDelete;
  int? shopDocument;
  int? shopdocumentList;
  int? shopdocumentAdd;
  int? shopdocumentEdit;
  int? shopdocumentDelete;
  ...
  RolesAndPermissionModel.fromJsonMap(Map<String, dynamic> map)
      : role = map["role"],
        ...
        shop = map["shop"],
        shopList = map["shop_list"],
        shopAdd = map["shop_add"],
        shopEdit = map["shop_edit"],
        shopDelete = map["shop_delete"],
        shopDocument = map["shop_document"],
        shopdocumentList = map["shopdocument_list"],
        shopdocumentAdd = map["shopdocument_add"],
        shopdocumentEdit = map["shopdocument_edit"],
        shopdocumentDelete = map["shopdocument_delete"],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['shop_add'] = shopAdd;
    data['shop_edit'] = shopEdit;
    data['shop_delete'] = shopDelete;
    data['shop_document'] = shopDocument;
    data['shopdocument_list'] = shopdocumentList;
    data['shopdocument_add'] = shopdocumentAdd;
    data['shopdocument_edit'] = shopdocumentEdit;
    data['shopdocument_delete'] = shopdocumentDelete;
