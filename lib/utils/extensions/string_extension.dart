...
extension intExt on String {
  ...
  String formatPhoneNumber(String phoneCode) {
    return const PhoneNumberService().buildE164(
      mobileNumber: this,
  ...
  (String, String) get extractPhoneCodeAndNumber {
    final parsedPhone = const PhoneNumberService().parseStoredContact(this);
    return (parsedPhone.country?.phoneCode ?? '', parsedPhone.localNumber);
  }
//endregion
}