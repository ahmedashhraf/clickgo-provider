...
class _AddPackageScreenState extends State<AddPackageScreen> {
  ...
  void init() async {
    ...
    if (isUpdate) {
      ...
      packageNameCont.text = translations[currentLang]?.name.validate() ?? translations[DEFAULT_LANGUAGE]?.name.validate() ?? widget.data?.name.validate() ?? "";
      packageDescriptionCont.text = translations[currentLang]?.description.validate() ?? translations[DEFAULT_LANGUAGE]?.description.validate() ?? widget.data?.description.validate() ?? "";
...
//endregion
  ...
  String _resolvedEnglishPackageDescription() {
    ...
    final String currentDescription = packageDescriptionCont.text.validate().trim();
    ...
    final req = {
      PackageKey.packageId: widget.data != null
          ? widget.data!.id.validate() != 0
              ...
              : null
          : null,
      PackageKey.name: _resolvedEnglishPackageName(),
      PackageKey.description: _resolvedEnglishPackageDescription(),
...
//region Get Translation Details
  void getTranslation() {
    ...
    if (languageCode == DEFAULT_LANGUAGE) {
      ...
      packageNameCont.text = name.isNotEmpty ? name : enTranslations.name.validate();
      packageDescriptionCont.text = description.isNotEmpty ? description : enTranslations.description.validate();
    }
    setState(() {});
  }
