...
class MidtransService {
  ...
  Future midtransPaymentCheckout() async {
    ...
    final String contactNumber = _phoneNumberService.buildE164(
      mobileNumber: appStore.userContactNumber,
      countryCode: '',
    );
    var midtransCustomer = MidtransCustomer(appStore.userFirstName, appStore.userLastName, appStore.userEmail, contactNumber);
