...
//-------------------------------- Variables -------------------------------//
  ...
  void init() async {
    ...
    if (isUpdate) {
      ...
      addonNameCont.text = translations[currentLang]?.name.validate().trim() ?? translations[DEFAULT_LANGUAGE]?.name.validate().trim() ?? widget.addonServiceData?.name.validate().trim() ?? "";
    ...
    final req = {
      AddonServiceKey.addonId: widget.addonServiceData != null
          ? widget.addonServiceData!.id.validate() != 0
              ...
              : null
          : null,
      AddonServiceKey.name: _resolvedEnglishAddonName(),
...
//region Get Translation Details
  void getTranslation() {
    ...
    if (languageCode == DEFAULT_LANGUAGE) {
      ...
      addonNameCont.text = name.isNotEmpty ? name : enTranslations.name.validate();
    }
    setState(() {});
  }
