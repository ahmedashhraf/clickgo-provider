...
class HandymanAddUpdateScreenState extends State<HandymanAddUpdateScreen> {
  ...
  void initState() {
    ...
    if (widget.data != null) {
      ...
      final parsedPhone = _phoneNumberService.parseStoredContact(widget.data!.contactNumber.validate());
                            ...
                            child: Center(
                              child: ValueListenableBuilder(
                                ...
                                builder: (context, value, child) {
                                  ...
                                  final String formattedCode = code.startsWith('+') ? code : '+$code';
