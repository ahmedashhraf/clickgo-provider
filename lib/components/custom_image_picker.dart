...
class CustomImagePicker extends StatefulWidget {
  ...
  final bool showErrorUnderBorder;
  final bool compactWhenNoImages;
  final double? height;
  final double? width;
  ...
  CustomImagePicker({
    ...
    this.errorText,
    this.showErrorUnderBorder = false,
    this.compactWhenNoImages = false,
    this.height,
    this.width,
    this.iconSize,
    this.textSize,
...
class _CustomImagePickerState extends State<CustomImagePicker> {
  ...
  Widget build(BuildContext context) {
    final bool hasErrorUnderBorder =
        widget.showErrorUnderBorder && widget.errorText.validate().isNotEmpty;
      ...
      children: [
        GestureDetector(
          ...
          child: DottedBorderWidget(
            color: widget.dottedBorderColor ?? context.primaryColor,
        ...
        if (hasErrorUnderBorder) ...[
          Padding(
            padding: const EdgeInsets.only(left: 12, top: 6),
            child: Text(
              widget.errorText.validate(),
              textAlign: TextAlign.start,
              style: primaryTextStyle(color: Colors.red, size: 10),
              maxLines: 2,
            ),
          ),
          8.height,
        ...
        if (imageFiles.isNotEmpty || !widget.compactWhenNoImages) ...[
          16.height,
          HorizontalList(
