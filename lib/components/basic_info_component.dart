  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          children: [
            ...
            if (showContactWidgets) ...[
              GestureDetector(
                onTap: () {
                  final String phoneNumber = _phoneNumberService.buildE164(
                    mobileNumber: contactNumber.validate(),
                    countryCode: '',
                  );
        ...
        if (widget.bookingDetail!.canCustomerContact && widget.flag == 0)
          Column(
            children: [
              ...
              if (widget.bookingDetail != null && widget.bookingDetail!.address.validate().isNotEmpty) ...[
                8.height,
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
        ...
        if ((contactNumber.validate().isNotEmpty && showContactWidgets) || (showChat && appConfigurationStore.isEnableChat)) ...[
          16.height,
          Row(
            children: [
              if (showContactWidgets) ...[
              ...
              if (appConfigurationStore.isEnableChat && showChat)
                AppButton(
