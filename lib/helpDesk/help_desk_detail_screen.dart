...
class _HelpDeskDetailScreenState extends State<HelpDeskDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final Color replyContainerColor = appStore.isDarkMode ? context.scaffoldBackgroundColor : context.cardColor;
    final Color replyInputColor = appStore.isDarkMode ? context.cardColor : white;
    final Color closeButtonColor = appStore.isDarkMode ? context.scaffoldBackgroundColor : context.cardColor;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: boxDecorationWithRoundedCorners(
                                        borderRadius: radius(),
                                        backgroundColor: replyContainerColor,
