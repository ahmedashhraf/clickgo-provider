...
abstract class _RolesAndPermissionStore with Store {
  ...
  @observable
  bool shop = getBoolAsync(SHOP);

  @observable
  bool shopList = getBoolAsync(SHOP_LIST);

  @observable
  bool shopAdd = getBoolAsync(SHOP_ADD);

  @observable
  bool shopEdit = getBoolAsync(SHOP_EDIT);

  @observable
  bool shopDelete = getBoolAsync(SHOP_DELETE);

  @observable
  bool shopDocument = getBoolAsync(SHOP_DOCUMENT);

  @observable
  bool shopdocumentList = getBoolAsync(SHOPDOCUMENT_LIST);

  @observable
  bool shopdocumentAdd = getBoolAsync(SHOPDOCUMENT_ADD);

  @observable
  bool shopdocumentEdit = getBoolAsync(SHOPDOCUMENT_EDIT);

  @observable
  bool shopdocumentDelete = getBoolAsync(SHOPDOCUMENT_DELETE);
  ...
  @observable
  bool isNearbyProviderEnable = getBoolAsync(IS_NEARBY_PROVIDER_ENABLE);
  ...
  @action
  Future<void> setShop(bool val) async {
    shop = val;
    await setValue(SHOP, val);
  }

  @action
  Future<void> setShopList(bool val) async {
    shopList = val;
    await setValue(SHOP_LIST, val);
  }

  @action
  Future<void> setShopAdd(bool val) async {
    shopAdd = val;
    await setValue(SHOP_ADD, val);
  }

  @action
  Future<void> setShopEdit(bool val) async {
    shopEdit = val;
    await setValue(SHOP_EDIT, val);
  }

  @action
  Future<void> setShopDelete(bool val) async {
    shopDelete = val;
    await setValue(SHOP_DELETE, val);
  }

  @action
  Future<void> setShopDocument(bool val) async {
    shopDocument = val;
    await setValue(SHOP_DOCUMENT, val);
  }

  @action
  Future<void> setShopdocumentList(bool val) async {
    shopdocumentList = val;
    await setValue(SHOPDOCUMENT_LIST, val);
  }

  @action
  Future<void> setShopdocumentAdd(bool val) async {
    shopdocumentAdd = val;
    await setValue(SHOPDOCUMENT_ADD, val);
  }

  @action
  Future<void> setShopdocumentEdit(bool val) async {
    shopdocumentEdit = val;
    await setValue(SHOPDOCUMENT_EDIT, val);
  }

  @action
  Future<void> setShopdocumentDelete(bool val) async {
    shopdocumentDelete = val;
    await setValue(SHOPDOCUMENT_DELETE, val);
  }
  ...
  @action
  Future<void> setIsNearbyProviderEnable(bool val) async {
    isNearbyProviderEnable = val;
    await setValue(IS_NEARBY_PROVIDER_ENABLE, val);
  }
}